...
namespace PomodoroAssistant
{
    ...
    sealed partial class App : Application
    {
        ...
        /// <summary>
        /// Inicjuje bazy danych
        /// </summary>
        private void InitDataBases()
        {
            // Ustawienia
            var _settings = SettingLocalData.Instance;
            // Cykle
            var _cycles = CyclesLocalData.Instance;
            // Stan timera - ustaw domyślny
            var _currentState = CurrentStateLocalData.Instance;
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            view.SetPreferredMinSize(new Size(400, 800));
